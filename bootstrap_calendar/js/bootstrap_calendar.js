...
(function ($) {
    $.fn.calendar = function (options) {
        ...
        this.each(function () {
            ...
            var monday_start_of_week;
            if (typeof args.monday_start_of_week != "undefined")
                monday_start_of_week = args.monday_start_of_week;
            else
                ...
                if (show_days != false) {
                    ...
                    if (!monday_start_of_week) {
                        ...
                        for (var i = 1; i < 7; i++) {
                            ...
                            insertCode += ">" + days[i] + '</td>';
                        }
                        insertCode += '<td';
                        insertCode += ' class="last"';
                        insertCode += ">" + days[0] + '</td>';
                    }
